...
const ICONS: Record<string, string> = {
  ...
  "gly-flag": `<path d="M4 2.75v10.5" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round"/><path d="M4 3.25h7l-1.6 2.4L11 8H4z" fill="currentColor" stroke="currentColor" stroke-width="1.1" stroke-linejoin="round"/>`,
